...
testLib.addTest('SHA-1', function (assert) {
...
testLib.addTest('HMAC-SHA1', function (assert) {
...
testLib.addTest('PBKDF2-HMAC-SHA1', function (assert) {
...
testLib.addAsyncTest('pbkdf2Lib Parallel', function (assert) {
    var params = {
        pass: "passwordPASSWORDpassword",
        salt: "saltSALTsaltSALTsaltSALTsaltSALTsalt",
        iterations: 4096,
    ...
    var pbkdfBlock = function (blockParams) {
        ...
        return pbkdf2.keyBlock(passBuf, saltBuf, blockParams.params.iterations, blockParams.blockIndex);
    };

    var par = new parallel(blocks, {});
    par.map(pbkdfBlock).then(function (blocks) {
...
testLib.runTests();
//# sourceMappingURL=pbkdf2_test.js.map
