...
exports.FastSha1 = FastSha1;

var hexlify = exports.hexlify = function(buf, len) {
	var hex = '';
...
FastSha1.prototype.initHeap = function(msgSize) {
	...
	if (!this.heap32 || heapSize > this.heap32.byteLength) {
		...
		this.core = new FastSha1.sha1Core(stdlib, null /* foreign - unused */, this.heap32.buffer);
	}
}

FastSha1.sha1Core = function(stdlib, foreign, heap) {
...
FastSha1.copyMsgToBe32 = function(dest, src, srcLen) {
...
FastSha1.strToBuf = function(srcStr, destBuf) {
	for (var i=0; i < srcStr.length; i++) {
		destBuf[i] = srcStr.charCodeAt(i);
	}
}

FastSha1.prototype.sha1 = function(src, srcLen, digest) {
